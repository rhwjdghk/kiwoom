$(function(){
    ...
    $(".header_nav,.header_bg").on({
        ...
        mouseover:function(){
            ...
            $(".header_nav").stop(true).animate({flexBasis:'67%'}),
            $(" .header_sub").css({
                width:'100%',
                height:'31vh',
                opacity:'1',
        ...
        mouseleave:function(){
            ...
            $(".header_nav").stop(true).animate({flexBasis:'55%'}),
            $(" .header_sub").css({
                width:'0',
                height:'0',
                opacity:'0',
    ...
    $(".pf_con").on({
        mouseover:function(){
            $(this).find("img").filter(":nth-child(3)").stop(true).animate({opacity:'1'},100),
            $(this).find(".text").find("span").css({color:'#D2C2C2'}),
            $(this).find(".text").find("p").css({color:'#fff'})
        },
        mouseout:function(){
            $(this).find("img").filter(":nth-child(3)").stop(true).animate({opacity:'0'},100),
            $(this).find(".text").find("span").css({color:'#2E2E2E'}),
            $(this).find(".text").find("p").css({color:'#000'})
        }
    })
